...
const navItems: NavItem[] = [
  ...
  { to: '/study', label: 'Blitz', icon: <BoltIcon /> },
  { to: '/exam', label: 'Exam Prep', icon: <ExamIcon /> },
  { to: '/subnetting', label: 'Subnetting', icon: <NetworkIcon /> },
  { to: '/pbq', label: 'PBQ Practice', icon: <LightbulbIcon /> },
